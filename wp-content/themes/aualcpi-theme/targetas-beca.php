<article id="post-<?php the_ID();?>" <?php post_class(); ?>>
	<div class="bloqueTargeta bloqueTargetaFormato bloqueTargetaFormatoBecas">
		<div class="row">
			<div class="col-xs-10 col-sm-12 col-xs-push-1 col-sm-push-0">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						?>
						<!-- <a href="#"  class="iconoModal" data-toggle="modal" data-target="#myModalBeca1">?</a> -->
						<?php //} ?>
						<!-- </p> -->
						<p class="categoriasAzules"><?php $terms_list=wp_get_post_terms($post->ID,'categoria');
						...
						?>
						<!-- <a href="#"  class="iconoModal" data-toggle="modal" data-target="#myModalBeca2">?</a> -->
						<?php // } ?>
